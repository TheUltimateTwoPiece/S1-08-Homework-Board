              ...
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <h2 className={`text-sm ${notification.read_at ? "hb-muted-text" : "hb-section-title"}`}>
                      {notification.title}
                    </h2>
                  </div>
                  <p className="hb-body-text text-sm leading-relaxed">
                    {notification.message}
                  </p>
                  <div className="hb-muted-text mt-3 flex items-center gap-2 text-xs">
