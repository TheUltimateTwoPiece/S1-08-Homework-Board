      ...
      {notifications && notifications.length > 0 ? (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-3 flex items-center gap-2 text-xs text-slate-600 dark:text-slate-200">
        ...
        <div className="hb-empty-state flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 py-16 text-center">
          ...
          {profile.role === "student" && (
            <p className="mt-1 max-w-xs text-xs text-slate-600 dark:text-slate-200">
