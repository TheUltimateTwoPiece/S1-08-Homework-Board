  ...
  return (
    <form action={formAction} className="space-y-3" encType="multipart/form-data">
      ...
      <div className="flex items-center gap-2">
        <label className="hb-card-section flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-2 text-xs transition hover:bg-slate-100 dark:hover:bg-stone-700/50">
