  ...
  return (
    <form action={formAction} className="space-y-3" encType="multipart/form-data">
      ...
      <div className="flex items-center gap-2">
        <label className="flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 hover:text-slate-700">
