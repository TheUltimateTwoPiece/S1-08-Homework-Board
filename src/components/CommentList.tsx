        ...
        <div className={`rounded-xl border bg-white p-4 shadow-sm transition hover:shadow-md ${
          ...
          <div className="mb-2 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              {isReply && (
                <span className="rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-medium text-slate-700 dark:text-slate-700">
                  Reply
                </span>
              )}
            </div>
                  ...
                  <li key={attachment.id} className="overflow-hidden rounded-lg border border-slate-200 transition hover:shadow-md">
                    <a href={attachment.url} target="_blank" rel="noreferrer" className="block">
                      {isImage ? (
                        ...
                        <div className="flex h-28 items-center justify-center bg-slate-50 text-xs font-semibold text-slate-700 dark:text-slate-700">
                          <div className="flex items-center gap-2">
                      ...
                      <div className="truncate px-3 py-2 text-xs text-slate-700 dark:text-slate-700">
